...
uint256 hashGenesisBlock("0xfaadd2f8d2905305244ca8574b73e1acfadcb1ed27f4ca9025e57368dc20152e");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1483311008, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Great new year 2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04ad7870e56aade661e1673ec4d73af48799ee1e82a87a4912dfc165125086443067d1b3c2bd53c93fed8eebf1ca2cd176f9b0f560a75838afdb5521d055840ff3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1483311008;
        ...
        assert(block.hashMerkleRoot == uint256("0xfd2cf1798253d0566841f2b7c244027bb646873c094869b71040f73b118fb96f"));
...
unsigned char pchMessageStart[4] = { 0x01, 0x90, 0x95, 0x45 }; // Tradecoin: increase each by adding 2 to bitcoin's value.
